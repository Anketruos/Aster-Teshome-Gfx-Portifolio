...
const projects = [
  {
    img: '../images/F1 general program.webp',
    type: 'Event Program',
  ...
  {
    img: '../images/F2 general program.webp',
    type: 'Event Program',
  ...
  {
    img: '../images/F3 general program.webp',
    type: 'Event Program',
  ...
  {
    img: '../images/F4 general program.webp',
    type: 'Event Program',
  ...
  {
    img: '../images/F5 general program.webp',
    type: 'Event Program',
  ...
  {
    img: '../images/F6 general program and GC goodbye.webp',
  ...
  {
    img: '../images/F7 I4U and Prayers retreat program.webp',
  ...
  {
    img: '../images/F7 count down 0 days left.webp',
  ...
  {
    img: '../images/F7 count down 1 days left.webp',
    type: 'Countdown Series',
  ...
  {
    img: '../images/F7 count down 2 days left.webp',
    type: 'Countdown Series',
  ...
  {
    img: '../images/F7 count down 3 days left.webp',
    type: 'Countdown Series',
  ...
  {
    img: '../images/F8 good luck on exam wish.webp',
  ...
  {
    img: '../images/F9 romans 15 13 verse poster.webp',
  ...
  {
    img: '../images/F10 galacians 3 13 verse poster.webp',
    type: 'Scripture Poster',
  ...
  {
    img: '../images/F11 2nd samuel 22 33 verse poster.webp',
    type: 'Scripture Poster',
  ...
  {
    img: '../images/F12 hebrews 11 1 verse poster.webp',
    type: 'Scripture Poster',
  ...
  {
    img: '../images/F13 philipians 1 19 verse poster.webp',
    type: 'Scripture Poster',
  ...
  data.forEach((p, i) => {
    ...
    card.innerHTML = `
      <div class="project-thumb">
        <img src="${p.img}" alt="${p.name}" class="project-thumb-img" loading="lazy" />
      </div>
